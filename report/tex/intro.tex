...
Syftet med uppgiften är att lära ut skalprogrammering som är mycket viktigt för
administration av mer avancerade datorsystem. Persondatorer typ laptops kan 
många gånger kontrolleras från ett grafiskt gränssnitt men större servrar och
system kan många gånger bara kontrolleras från ett kommandoradsgränssnitt.
Det är därför avgörande att ha bra koll på skalprogrammering. Eftersom att
\texttt{bash} är väldigt vanligt förekommando och dessutom har en del gemensamt
med övriga skalprogram så är det lämpligt att läras sig skriva programkod som
körs med \texttt{bash} (\cite{forelasning02}).
