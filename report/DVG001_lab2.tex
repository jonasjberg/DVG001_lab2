...
\begin{document}
  ...
  \begin{center}
  \begin{tabular}{l r}
    Utförd: & \isodate \printdate{2016-03-03} -- \today \\
  ...
  \begin{abstract}
    ...
    Laborationen behandlar skapandet av ett enklare skalprogram eller
    \texttt{bash}-skript.  Uppgiften innefattar en rad vanliga kommandon och
    uppgifter som ingår i administration av \texttt{*nix}-system.
  \end{abstract}
